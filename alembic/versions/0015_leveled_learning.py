# alembic/versions/0015_leveled_learning.py
"""leveled_progress
...
def upgrade() -> None:
    # leveled_progress — прогресс раздела «English by level» в личке.
    # Одна строка на профиль; живое состояние в JSONB state.
    op.create_table(
        "leveled_progress",
